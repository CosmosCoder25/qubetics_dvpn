...
import (
	...
	"github.com/qubetics/qubetics-blockchain/v2/testutil/integration/common/network"
	ibcchain "github.com/qubetics/qubetics-blockchain/v2/testutil/integration/ibc/chain"
)
...
func (c *IntegrationCoordinator) Setup(a, b string) IBCConnection {
	...
	path := qubeticsibc.NewTransferPath(chainA, chainB)
	qubeticsibc.SetupPath(c.coord, path)
