...
func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.Qubetics, addr sdk.AccAddress, balance math.Int, rewards ...math.Int) (sdk.Context, error) {
