...
func Call(ctx sdk.Context, app *qubeticsapp.Qubetics, args CallArgs) (res abci.ResponseDeliverTx, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
	...
	res, err = qubeticsutil.DeliverEthTx(app, args.PrivKey, msg)
	if err != nil {
...
func CallContractAndCheckLogs(ctx sdk.Context, app *qubeticsapp.Qubetics, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ResponseDeliverTx, *evmtypes.MsgEthereumTxResponse, error) {
