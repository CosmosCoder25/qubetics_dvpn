...
var (
	...
	validAttoTraceDenom = types.DenomTrace{Path: "channel-0", BaseDenom: "tics"}
	// validTraceDenomNoMicroAtto is a denomination trace with a valid IBC voucher name but no micro or atto prefix
	validTraceDenomNoMicroAtto = types.DenomTrace{Path: "channel-0", BaseDenom: "mtics"}
...
func (s *PrecompileTestSuite) TestNameSymbol() {
	...
	testcases := []struct {
		name        string
		denom       string
		malleate    func(sdk.Context, *app.Qubetics)
		expPass     bool
		errContains string
		expName     string
		expSymbol   string
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.Qubetics) {
...
func (s *PrecompileTestSuite) TestTotalSupply() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.Qubetics, *big.Int)
		expPass     bool
		errContains string
		expTotal    *big.Int
	}{
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.Qubetics, amount *big.Int) {
				// NOTE: we mint some coins to the inflation module address to be able to set denom metadata
...
func (s *PrecompileTestSuite) TestBalanceOf() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.Qubetics, *big.Int) []interface{}
		expPass     bool
		errContains string
		expBalance  *big.Int
	}{
		{
			...
			malleate: func(_ sdk.Context, _ *app.Qubetics, _ *big.Int) []interface{} {
				return []interface{}{}
			},
		...
		{
			name: "pass - some coins",
			malleate: func(ctx sdk.Context, app *app.Qubetics, amount *big.Int) []interface{} {
...
func (s *PrecompileTestSuite) TestAllowance() {
	...
	testcases := []struct {
		...
		},
		{
			...
			malleate: func(_ sdk.Context, _ *app.Qubetics, amount *big.Int) []interface{} {
				granterIdx := 0
				granteeIdx := 1
