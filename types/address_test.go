...
func TestNodeAddressFromBech32(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			"invalid prefix",
			args{
				s: "qubetics1qypqxpq9qcrsszgszyfpx9q4zct3sxfq0fzduj",
			},
			nil,
			true,
		},
		{
			"20 bytes",
			args{
				s: "qubeticsnode1qypqxpq9qcrsszgszyfpx9q4zct3sxfqelr5ey",
			},
...
func TestNodeAddress_MarshalJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			"10 bytes",
			NodeAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10},
			[]byte(`"qubeticsnode1qypqxpq9qcrsszgse4wwrm"`),
			false,
		},
		{
			"20 bytes",
			NodeAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20},
			[]byte(`"qubeticsnode1qypqxpq9qcrsszgszyfpx9q4zct3sxfqelr5ey"`),
			false,
		},
		{
			"30 bytes",
			NodeAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x30},
			[]byte(`"qubeticsnode1qypqxpq9qcrsszgszyfpx9q4zct3sxfqyy3zxfp9ycnjs2fsxqglcv"`),
			false,
		},
	}
	for _, tt := range tests {
...
func TestNodeAddress_MarshalYAML(t *testing.T) {
	tests := []struct {
		...
		},
		{
			"10 bytes",
			NodeAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10},
			"qubeticsnode1qypqxpq9qcrsszgse4wwrm",
			false,
		},
		{
			"20 bytes",
			NodeAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20},
			"qubeticsnode1qypqxpq9qcrsszgszyfpx9q4zct3sxfqelr5ey",
			false,
		},
		{
			"30 bytes",
			NodeAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x30},
			"qubeticsnode1qypqxpq9qcrsszgszyfpx9q4zct3sxfqyy3zxfp9ycnjs2fsxqglcv",
			false,
		},
	}
	for _, tt := range tests {
...
func TestNodeAddress_UnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			NodeAddress{},
			args{
				data: []byte(`"qubeticsnode1qypqxpq9qcrsszgse4wwrm"`),
			},
			false,
		},
		{
			...
			NodeAddress{},
			args{
				data: []byte(`"qubeticsnode1qypqxpq9qcrsszgszyfpx9q4zct3sxfqelr5ey"`),
			},
			false,
		},
		{
			...
			NodeAddress{},
			args{
				data: []byte(`"qubeticsnode1qypqxpq9qcrsszgszyfpx9q4zct3sxfqyy3zxfp9ycnjs2fsxqglcv"`),
			},
			false,
		},
	}
...
func TestProvAddressFromBech32(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"invalid prefix",
			args{s: "qubetics1qypqxpq9qcrsszgszyfpx9q4zct3sxfq0fzduj"},
			nil,
			true,
		},
		{
			"20 bytes",
			args{
				s: "qubeticsprov1qypqxpq9qcrsszgszyfpx9q4zct3sxfq877k82",
			},
...
func TestProvAddress_MarshalJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			"10 bytes",
			ProvAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10},
			[]byte(`"qubeticsprov1qypqxpq9qcrsszgsutj8xr"`),
			false,
		},
		{
			"20 bytes",
			ProvAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20},
			[]byte(`"qubeticsprov1qypqxpq9qcrsszgszyfpx9q4zct3sxfq877k82"`),
			false,
		},
		{
			"30 bytes",
			ProvAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x30},
			[]byte(`"qubeticsprov1qypqxpq9qcrsszgszyfpx9q4zct3sxfqyy3zxfp9ycnjs2fsh33zgx"`),
			false,
		},
	}
	for _, tt := range tests {
...
func TestProvAddress_MarshalYAML(t *testing.T) {
	tests := []struct {
		...
		},
		{
			"10 bytes",
			ProvAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10},
			"qubeticsprov1qypqxpq9qcrsszgsutj8xr",
			false,
		},
		{
			"20 bytes",
			ProvAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20},
			"qubeticsprov1qypqxpq9qcrsszgszyfpx9q4zct3sxfq877k82",
			false,
		},
		{
			"30 bytes",
			ProvAddress{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x30},
			"qubeticsprov1qypqxpq9qcrsszgszyfpx9q4zct3sxfqyy3zxfp9ycnjs2fsh33zgx",
			false,
		},
	}
	for _, tt := range tests {
...
func TestProvAddress_UnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			ProvAddress{},
			args{
				data: []byte(`"qubeticsprov1qypqxpq9qcrsszgsutj8xr"`),
			},
			false,
		},
		{
			...
			ProvAddress{},
			args{
				data: []byte(`"qubeticsprov1qypqxpq9qcrsszgszyfpx9q4zct3sxfq877k82"`),
			},
			false,
		},
		{
			...
			ProvAddress{},
			args{
				data: []byte(`"qubeticsprov1qypqxpq9qcrsszgszyfpx9q4zct3sxfqyy3zxfp9ycnjs2fsh33zgx"`),
			},
			false,
		},
	}
