...
// EthSetup initializes a new QubeticsApp. A Nop logger is set in QubeticsApp.
func EthSetup(isCheckTx bool, patchGenesis func(*Qubetics, simapp.GenesisState) simapp.GenesisState) *Qubetics {
	return EthSetupWithDB(isCheckTx, patchGenesis, dbm.NewMemDB())
}

// EthSetupWithDB initializes a new QubeticsApp. A Nop logger is set in QubeticsApp.
func EthSetupWithDB(isCheckTx bool, patchGenesis func(*Qubetics, simapp.GenesisState) simapp.GenesisState, db dbm.DB) *Qubetics {
	chainID := utils.TestnetChainID + "-1"
	app := NewQubetics(log.NewNopLogger(),
		db,
		nil,
		true,
		map[int64]bool{},
