...
import (
	...
	commontestfactory "github.com/qubetics/qubetics-blockchain/v2/testutil/integration/common/factory"
...
func TestQubeticsExport(t *testing.T) {
	// create public key
	privVal := mock.NewPV()
	...
	genesisState = app.GenesisStateWithValSet(qubeticsApp, genesisState, valSet, []authtypes.GenesisAccount{acc}, balance)
