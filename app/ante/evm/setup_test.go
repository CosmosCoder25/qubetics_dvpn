...
import (
	...
	ante "github.com/qubetics/qubetics-blockchain/v2/app/ante"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.app = app.EthSetup(checkTx, func(app *app.Qubetics, genesis simapp.GenesisState) simapp.GenesisState {
	...
	// set staking denomination to Qubetics denom
