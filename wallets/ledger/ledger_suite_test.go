...
import (
	...
	"github.com/qubetics/qubetics-blockchain/v2/wallets/ledger/mocks"
...
type LedgerTestSuite struct {
	...
	txAmino    []byte
	txProtobuf []byte
	ledger     ledger.QubeticsSECP256K1
...
func (suite *LedgerTestSuite) SetupTest() {
	...
	suite.ledger = ledger.QubeticsSECP256K1{Hub: hub, PrimaryWallet: mockWallet}
}
