...
import (
	...
	enccodec "github.com/qubetics/qubetics-blockchain/v2/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("qubetics", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, qubeticstypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
	...
	hdPath := qubeticstypes.BIP44HDPath
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, qubeticstypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(qubeticstypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Qubetics implementation
	...
	// Equality of Eth and Qubetics implementation
	...
	// Inequality of wrong derivation path of Eth and Qubetics implementation
