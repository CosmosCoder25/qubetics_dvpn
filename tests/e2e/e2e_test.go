...
// TestUpgrade tests if an Qubetics node can be upgraded from one version to another.
...
// TestCLITxs executes different types of transactions against an Qubetics node
