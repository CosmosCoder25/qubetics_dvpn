...
func (s *IntegrationTestSuite) executeTransactions() {
	...
	// TODO: Add more transactions in qubetics (e.g. staking precompile)
...
func (s *IntegrationTestSuite) sendBankTransfer(ctx context.Context, chainID string) {
	receiver := "qubetics1jcltmuhplrdcwp7stlr4hlhlhgd4htqh3a79sq"
	sentCoins := sdk.Coins{sdk.NewInt64Coin("tics", 10000000000)}
