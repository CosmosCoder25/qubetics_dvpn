...
// TestQubeticsVersionsLess tests the QubeticsVersions type's Less method with
// different version strings
func TestQubeticsVersionsLess(t *testing.T) {
	var version QubeticsVersions
...
// TestQubeticsVersionsSwap tests the QubeticsVersions type's Swap method
func TestQubeticsVersionsSwap(t *testing.T) {
	var version QubeticsVersions
	value := "v9.1.0"
...
// TestQubeticsVersionsLen tests the QubeticsVersions type's Len method
func TestQubeticsVersionsLen(t *testing.T) {
	var version QubeticsVersions = []string{"v9.1.0", "v10.0.0"}
