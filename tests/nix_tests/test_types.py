...
def test_block(qubetics_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on qubetics and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(qubetics_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(qubetics_cluster, geth, True)


def get_blocks(qubetics_rpc_ws, geth, with_transactions):
    w3: Web3 = qubetics_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    qubetics_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [qubetics_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(eth_rpc, geth_rpc, "eth_accounts", [])


def test_syncing(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(qubetics_cluster, geth):
    # on qubetics the proof query will fail for block numbers <= 2
...
def test_get_code(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(qubetics_cluster, geth):
    w3: Web3 = qubetics_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(qubetics_cluster, geth):
...
def test_incomplete_send_transaction(qubetics_cluster, geth):
