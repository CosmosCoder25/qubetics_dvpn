...
different Qubetics and [Geth](https://github.com/ethereum/go-ethereum) clients with multiple configurations.
...
If you're changing anything on the qubetics rpc, rerun the first command.
