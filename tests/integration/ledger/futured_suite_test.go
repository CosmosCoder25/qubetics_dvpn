...
import (
	...
	"github.com/qubetics/qubetics-blockchain/v2/tests/integration/ledger/mocks"
	...
	qubeticskeyring "github.com/qubetics/qubetics-blockchain/v2/crypto/keyring"
...
func (suite *LedgerTestSuite) SetupQubeticsApp() {
...
func (suite *LedgerTestSuite) qubeticsAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = qubeticskeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = qubeticskeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = qubeticskeyring.CreatePubkey
		options.LedgerAppName = qubeticskeyring.AppName
		options.LedgerSigSkipDERConv = qubeticskeyring.SkipDERConversion
	}
}
