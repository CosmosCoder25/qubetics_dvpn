...
// source: qubetics/provider/v2/events.proto
...
func (*EventRegister) Descriptor() ([]byte, []int) {
	return fileDescriptor_5475ffdb7024d17f, []int{0}
}
...
func (*EventUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_5475ffdb7024d17f, []int{1}
}
...
func init() {
	proto.RegisterType((*EventRegister)(nil), "qubetics.provider.v2.EventRegister")
	proto.RegisterType((*EventUpdate)(nil), "qubetics.provider.v2.EventUpdate")
}

func init() { proto.RegisterFile("qubetics/provider/v2/events.proto", fileDescriptor_5475ffdb7024d17f) }

var fileDescriptor_5475ffdb7024d17f = []byte{
	...
	0x39, 0x23, 0x31, 0x33, 0x0f, 0x14, 0x04, 0x15, 0x88, 0x00, 0x29, 0xa9, 0x2c, 0x48, 0x2d, 0xd6,
	0x2f, 0x33, 0x4a, 0x62, 0x03, 0x7b, 0xd2, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x39, 0x1b, 0x5e,
	0x39, 0x35, 0x01, 0x00, 0x00,
}
