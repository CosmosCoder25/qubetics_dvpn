...
func (suite *ParamsTestSuite) TestParamsValidate() {
	testCases := []struct {
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{types.WQUBETICSContractMainnet})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{types.WQUBETICSContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{types.WQUBETICSContractTestnet, types.WQUBETICSContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			// order of creation shouldn't matter since it should be sorted when defining new param
			func() types.Params {
				return types.NewParams(true, []string{types.WQUBETICSContractMainnet, types.WQUBETICSContractTestnet}, []string{})
			},
			false,
			"",
		},
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{types.WQUBETICSContractMainnet}, []string{types.WQUBETICSContractMainnet})
			},
			true,
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{types.WQUBETICSContractMainnet, types.WQUBETICSContractMainnet}, []string{})
			},
			true,
			"duplicate precompile",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{types.WQUBETICSContractMainnet, types.WQUBETICSContractMainnet})
			},
			true,
			"duplicate precompile",
		},
		...
		},
		{
			...
			func() types.Params {
				...
				params.NativePrecompiles = []string{types.WQUBETICSContractTestnet, types.WQUBETICSContractMainnet}
				return params
			},
			true,
...
func (suite *ParamsTestSuite) TestIsNativePrecompile() {
	testCases := []struct {
	...
	}{
		{
			"default",
			types.DefaultParams,
			common.HexToAddress(types.WQUBETICSContractMainnet),
			true,
		},
		{
		...
		},
		{
			...
			common.HexToAddress(types.WQUBETICSContractTestnet),
			true,
		},
		{
