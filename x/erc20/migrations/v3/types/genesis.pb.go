...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "qubetics.erc20.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "qubetics.erc20.v1.V3Params")
}

func init() { proto.RegisterFile("qubetics/erc20/v1/genesis.proto", fileDescriptor_2f4674601b0d6987) }
