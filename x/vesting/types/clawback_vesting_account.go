...
// ComputeClawback returns an account with all qubetics vesting events removed and
// the clawback amount (total sum of these events). Qubetics unlocking events are
