...
// source: qubetics/session/v1/msg.proto
...
func (*MsgEndRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_760c98b552100aef, []int{0}
}
...
func (*MsgStartRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_760c98b552100aef, []int{1}
}
...
func (*MsgUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_760c98b552100aef, []int{2}
}
...
func (*MsgEndResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_760c98b552100aef, []int{3}
}
...
func (*MsgStartResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_760c98b552100aef, []int{4}
}
...
func (*MsgUpdateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_760c98b552100aef, []int{5}
}
...
func init() {
	proto.RegisterType((*MsgEndRequest)(nil), "qubetics.session.v1.MsgEndRequest")
	proto.RegisterType((*MsgStartRequest)(nil), "qubetics.session.v1.MsgStartRequest")
	proto.RegisterType((*MsgUpdateRequest)(nil), "qubetics.session.v1.MsgUpdateRequest")
	proto.RegisterType((*MsgEndResponse)(nil), "qubetics.session.v1.MsgEndResponse")
	proto.RegisterType((*MsgStartResponse)(nil), "qubetics.session.v1.MsgStartResponse")
	proto.RegisterType((*MsgUpdateResponse)(nil), "qubetics.session.v1.MsgUpdateResponse")
}

func init() { proto.RegisterFile("qubetics/session/v1/msg.proto", fileDescriptor_760c98b552100aef) }

var fileDescriptor_760c98b552100aef = []byte{
	...
	,
}
...
func (c *msgServiceClient) MsgStart(ctx context.Context, in *MsgStartRequest, opts ...grpc.CallOption) (*MsgStartResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/qubetics.session.v1.MsgService/MsgStart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) MsgUpdate(ctx context.Context, in *MsgUpdateRequest, opts ...grpc.CallOption) (*MsgUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/qubetics.session.v1.MsgService/MsgUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) MsgEnd(ctx context.Context, in *MsgEndRequest, opts ...grpc.CallOption) (*MsgEndResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/qubetics.session.v1.MsgService/MsgEnd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgService_MsgStart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qubetics.session.v1.MsgService/MsgStart",
	}
...
func _MsgService_MsgUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qubetics.session.v1.MsgService/MsgUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_MsgEnd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qubetics.session.v1.MsgService/MsgEnd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _MsgService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "qubetics.session.v1.MsgService",
	...
	Metadata: "qubetics/session/v1/msg.proto",
}
