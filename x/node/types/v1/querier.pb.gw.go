...
var (
	pattern_QueryService_QueryNodes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"qubetics", "node", "v1", "nodes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_QueryService_QueryNodesForProvider_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"qubetics", "node", "v1", "providers", "address", "nodes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_QueryService_QueryNode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"qubetics", "node", "v1", "nodes", "address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_QueryService_QueryParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"qubetics", "node", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))
)
