...
// This test suite is meant to test the EVM module in the context of the QUBETICS.
// It uses the integration test framework to spin up a local QUBETICS network and
