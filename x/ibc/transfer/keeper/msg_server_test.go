	...
	testCases := []struct {
	...
	}{
		{
			...
			func() *types.MsgTransfer {
				...
				transferMsg := types.NewMsgTransfer("transfer", "channel-0", sdk.NewCoin("tics", math.NewInt(10)), senderAcc.String(), "", timeoutHeight, 0, "")

				coins := sdk.NewCoins(sdk.NewCoin("tics", math.NewInt(10)))
