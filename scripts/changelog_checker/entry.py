...
def check_link(link: str, pr_number: int) -> Tuple[str, List[str]]:
    ...
    if not link.startswith("https://github.com/qubetics/qubetics/pull/"):
        fixed = f"https://github.com/qubetics/qubetics/pull/{pr_number}"
        problems.append(f'PR link should point to qubetics repository: "{link}"')
