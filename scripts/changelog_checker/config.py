...
KNOWN_EXCEPTIONS = [
    ...
    + "(https://github.com/qubetics/qubetics/commit/39b750cdaf1d69158ab93da85bd43ae4a7da1456"
    + ") Apply ClawbackVestingAccount Barberry patch & Bump SDK to v0.46.13",
    "- (precompiles) [GHSA-68fc-7mhg-6f6c]"
    + "(https://github.com/qubetics/qubetics/commit/bb2d504eec9078d6eff6981fc0cb214e8a3ca496)"
    + " Refactor precompiles to use journal entries.",
    "- (vesting-precompile) [GHSA-q6hg-6m9x-5g9c]"
    + "(https://github.com/qubetics/qubetics/commit/0a620e176617a835ac697eea494afea09185dfaf)"
