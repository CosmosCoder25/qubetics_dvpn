...
class TestParseChangelog:
        ...
        expected_result = {
            "Unreleased": {
                "State Machine Breaking": {
                    ...
                    1687: {"description": "Bump Qubetics version to v14."},
                },
                "API Breaking": {
                    2015: {
                ...
                "Improvements": {
                    ...
                    701: {"description": "Rename Go module to `qubetics/qubetics`."},
                },
                "Bug Fixes": {
    ...
    def test_fail(self):
        ...
        assert changelog.problems == [
            'PR link is not matching PR number 1948: "https://github.com/qubetics/qubetics/pull/1949"',
