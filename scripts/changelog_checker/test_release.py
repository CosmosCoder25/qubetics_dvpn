...
class TestRelease:
    def test_pass(self):
        release = Release(
            "## [v15.0.2](https://github.com/qubetics/qubetics/releases/tag/v15.0.2) - 2021-08-02"
        )
    ...
    def test_wrong_version_in_link(self):
        release = Release(
            "## [v15.0.2](https://github.com/qubetics/qubetics/releases/tag/v16.0.0) - 2021-08-02"
        )
        assert release.parse() is False
        assert release.version == "v15.0.2"
        assert release.problems == [
            'Release header version "v15.0.2" does not match version in link '
            + '"https://github.com/qubetics/qubetics/releases/tag/v16.0.0"'
        ]

    def test_wrong_base_url(self):
        release = Release(
            "## [v15.0.2](https://github.com/qubetics/evmds/releases/tag/v15.0.2) - 2021-08-02"
        )
        assert release.parse() is False
        assert release.version == "v15.0.2"
        assert release.problems == [
            'Release link should point to an Qubetics release: "https://github.com/qubetics/evmds/releases/tag/v15.0.2"'
        ]
