...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "qubeticsd", "Home directory of the node's daemon configuration")
...
func initTestnetFiles(
	...
	if args.chainID == "" {
		args.chainID = fmt.Sprintf("qubetics_%d-1", tmrand.Int63n(9999999999999)+1)
	}
	...
	for i := 0; i < args.numValidators; i++ {
		...
		kb, err := keyring.New(sdk.KeyringServiceName(), args.keyringBackend, nodeDir, inBuf, clientCtx.Codec, qubeticskr.Option())
		if err != nil {
			return err
		}
